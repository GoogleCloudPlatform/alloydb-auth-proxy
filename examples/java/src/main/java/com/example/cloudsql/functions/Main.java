...
package com.example.alloydb.functions;

import com.example.alloydb.TcpConnectionPoolFactory;
import com.example.alloydb.TemplateData;
import com.example.alloydb.Utils;
...
public class Main implements HttpFunction {
  ...
  private static class PoolHolder {
    ...
    private static DataSource setupPool() {
      DataSource pool = TcpConnectionPoolFactory.createConnectionPool();
