...
// mustConnect creates a connection to the database using a TCP socket.
...
func configureConnectionPool(db *sql.DB) {
	// [START alloydb_databasesql_limit]
	// Set maximum number of connections in idle connection pool.
	db.SetMaxIdleConns(5)

	// Set maximum number of open connections to the database.
	db.SetMaxOpenConns(7)
	// [END alloydb_databasesql_limit]

	// [START alloydb_databasesql_lifetime]
	// Set Maximum time (in seconds) that a connection can remain open.
	db.SetConnMaxLifetime(1800 * time.Second)
	// [END alloydb_databasesql_lifetime]

	// [START alloydb_databasesql_backoff]
	// database/sql does not support specifying backoff
	// [END alloydb_databasesql_backoff]
	// [START alloydb_databasesql_timeout]
	// The database/sql package currently doesn't offer any functionality to
	// configure connection timeout.
	// [END alloydb_databasesql_timeout]
}
