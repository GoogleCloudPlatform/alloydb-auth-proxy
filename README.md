...
URL="https://storage.googleapis.com/alloydb-auth-proxy/v1.10.1"
...
``` sh
# see Releases for other versions
wget https://storage.googleapis.com/alloydb-auth-proxy/v1.10.1/alloydb-auth-proxy-x64.exe -O alloydb-auth-proxy.exe
```
</details>
...
``` sh
# see Releases for other versions
wget https://storage.googleapis.com/alloydb-auth-proxy/v1.10.1/alloydb-auth-proxy-x86.exe -O alloydb-auth-proxy.exe
```
</details>
...
``` shell
# $VERSION is 1.10.1
docker pull gcr.io/alloydb-connectors/alloydb-auth-proxy:1.10.1
```
